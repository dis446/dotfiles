...
2. Write or update deterministic Playwright journeys in the `platform-2`
...
5. Never weaken an existing assertion to make a test pass. A red test on the
   ...
   and say so).
6. Commit + push your spec changes to the `platform-2` worktree's branch
