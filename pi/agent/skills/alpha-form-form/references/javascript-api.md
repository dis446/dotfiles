...
Component instances expose `setValue`, `getValue`, `disabled`, `visible`, `component` (the JSON schema), and `redraw()`. For bulk traversal use the Utilities documented in the `alpha-form-sdk` skill (`../../alpha-form-sdk/references/utils-form-traversal.md`).
