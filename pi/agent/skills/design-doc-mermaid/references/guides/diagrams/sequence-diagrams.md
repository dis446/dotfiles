...
sequenceDiagram
    ...
    AuthProvider-->>-App: {<br/>  access_token: "<jwt-placeholder-example>",<br/>  refresh_token: "abc...",<br/>  expires_in: 3600<br/>}

    App->>+AuthProvider: GET /userinfo<br/>Authorization: Bearer <jwt-placeholder-example>
...
sequenceDiagram
    ...
    API-->>-Client: HTTP 200 OK<br/>{<br/>  access_token: "<jwt-placeholder-example>",<br/>  refresh_token: "abc...",<br/>  expires_in: 900<br/>}

    Note over Client,DB: Subsequent API Requests

    Client->>+API: GET /api/protected-resource<br/>Authorization: Bearer <jwt-placeholder-example>
    ...
    API-->>-Client: HTTP 200 OK<br/>{access_token: "<jwt-placeholder-example>new"}

    Client->>+API: GET /api/protected-resource<br/>Authorization: Bearer <jwt-placeholder-example>new
    API->>AuthService: Verify JWT
