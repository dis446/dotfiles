...
sudo dnf install git vim neovim lazygit podman-docker mise htop ncdu speedtest-cli pip3 golang kubectl gcc-c++ make mpv-libs glab ghostty -y --skip-unavailable
