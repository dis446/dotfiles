...
repo, herdr setup, and platform-1 feature workflow). Perform the pi-session migration below so this
...
- repo-1 repo, branch `disney`, commit `527506d0`
...
Hardcoded path caveat: the reference script encodes `OLD_FEATURES=/home/dubby/Code/<org>/<platform-1>/
features` and `NEW_FEATURES=/home/dubby/Code/<org>/<platform-1>/back-end/repo-1/features`
