...
```
┌────────────────────────────────────────────────┐
│ tmux session "platform-2"     (1 window, 1 pane)     │
│ ┌────────────────────────────────────────────┐ │
│ │  Neovim                                    │ │
│ │  ┌──────┬────────────────┬──────────────┐  │ │
...
| `platform-2`        | platform-2 monorepo / core service                  |
| `platform-2`  | platform-2 client service                           |
| `platform-2`  | platform-2 config service                           |
| `platform-2`    | platform-2 Naut service                             |
| `platform-2`   | platform-2 Sales service                            |
| `platform-2`     | platform-2 Web service                              |
| `home`        | `~` — home directory                          |
| `repo-4`  | repo-4 project                            |
| `vpn`         | VPN management                                |
