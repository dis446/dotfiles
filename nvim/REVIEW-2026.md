...
- `nvim/lua/dis446/plugins/platform-1.lua`
...
- `snacks.dashboard` instead of `env-name`
...
|---|---|---|---|
| `goolord/env-name` | `nvim/lua/dis446/plugins/platform-1.lua` | `snacks.dashboard` | **Remove** |
...
2. Replace `env-name` with `snacks.dashboard`
