...
1. Open one project normally (e.g., `platform-2`)
...
| **Nx Console** | Visual Nx task runner for the platform-2 umbrella |
...
4. **Set up run configurations** — For platform-2, create run configs for each
